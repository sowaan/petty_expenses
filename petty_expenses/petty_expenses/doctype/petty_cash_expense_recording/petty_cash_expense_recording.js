        ...
        if (!frm.is_new() && frm.doc.docstatus === 1) {
            ...
            if (!frm.doc.journal_entry) {
                frm.add_custom_button(
                    ...
                    function () {
                        frappe.call({
                            method: "petty_expenses.petty_expenses.doctype.petty_cash_expense_recording.petty_cash_expense_recording.make_journal_entry",
                            args: {
...
frappe.ui.form.on('Petty Expenses', {
    expense_type(frm, cdt, cdn) {
        ...
        frappe.call({
            method: "petty_expenses.petty_expenses.doctype.petty_cash_expense_recording.petty_cash_expense_recording.get_expense_account",
            args: {
